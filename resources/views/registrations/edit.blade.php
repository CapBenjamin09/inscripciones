<x-layouts.app-layout>
    <div class="container p-2 px-10 py-10 rounded-lg bg-white shadow-xl">
        ...
        <div class="flex justify-center py-10">
            ...
            <p class="items-center text-5xl py-4 px-2 font-bold">&nbsp; Editar inscripción</p>
        </div>
        ...
        <form class="max-w-lg mx-auto pt-5" action="{{ route('registrations.update', $registration) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PATCH')
