<x-layouts.app-layout>
    ...
    <div class="container p-2 px-10 py-10 rounded-lg bg-white shadow-xl">
        ...
        <img class="shadow-md w-20 h-20 p-2 rounded-2xl ring-2 ring-gray-300 bg-sky-200" src="{{ asset('img/crear.png') }}" alt="Bordered avatar">
        <p class="items-center text-5xl py-4 px-2 font-semibold"> Crear usuario</p>
        </div>

        <form class="max-w-md mx-auto pt-5" action="{{ route('users.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-5">
                ...
                <input type="email" name="email" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            </div>
            <div>
