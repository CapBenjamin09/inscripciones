        ...
        <form class="max-w-3xl mx-auto formulario-eliminar" method="POST" action="{{ route('schedules.update', $schedule) }}">
            ...
            <div class="max-w-xl mx-auto mt-16 mb-16 flex w-full flex-col border rounded-lg bg-white p-8">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="degree" name="degree" value="{{ $schedule->degree }}" class="w-full resize-none rounded border border-gray-300 bg-white py-2 px-3 text-base leading-6 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">
                </div>
