    ...
    <div class="container mx-1 p-2 px-8 py-10 rounded-lg bg-white shadow-xl">
        ...
        <form class="max-w-3xl mx-auto formulario-eliminar" method="POST" action="{{ route('schedules.update', $schedule) }}">
            ...
            <div class="max-w-xl mx-auto mt-16 mb-16 flex w-full flex-col border rounded-lg bg-white p-8">
                ...
                <p class="mb-5 leading-relaxed text-gray-600">Agrega los datos solicitados para editarlos.
                </p>


                <div class="mb-4">
                    <label for="title" class="text-sm leading-7 text-gray-600">Titulo</label>
                    <input type="text" id="title" name="title" value="{{ $schedule->title }}" class="w-full rounded border border-gray-300 bg-white py-1 px-3 text-base leading-8 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200" />
                </div>
                <div class="mb-4">
                    <label for="assignment" class="text-sm leading-7 text-gray-600">Grado o Docente</label>
                    <input type="text" id="assignment" name="assignment" value="{{ $schedule->assignment }}" class="w-full resize-none rounded border border-gray-300 bg-white py-2 px-3 text-base leading-6 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">
                </div>
