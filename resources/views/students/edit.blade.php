<x-layouts.app-layout>
    ...
    <div class="container p-2 px-10 py-10 rounded-lg bg-white shadow-xl">
        ...
        <div class="flex justify-center py-10">
            <img class="shadow-md w-20 h-20 p-2 rounded-2xl ring-2 ring-gray-300 bg-sky-200" src="{{ asset('img/edit_student.png') }}" alt="Bordered avatar">
            <p class="items-center text-5xl py-4 px-2 font-bold">&nbsp; Editar alumno</p>
        </div>
        ...
        <form class="max-w-lg mx-auto pt-5" action="{{ route('students.update', $student) }}" method="POST">
            @csrf
            @method('PATCH')
