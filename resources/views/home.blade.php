<x-layouts.app-layout>
    ...
    <div class="max-w-5xl mx-auto mt-8 space-y-4 md:mt-16">
        <div
            ...
            <div class="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                <span class="flex text-lg font-semibold text-black">Hola, {{ auth()->user()->name }}</span>
            </div>
        </div>

        <div class="grid grid-cols-1 gap-8 p-10 mt-14 lg:grid-cols-2">
            <!-- Value card -->
